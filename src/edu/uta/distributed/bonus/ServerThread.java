...
import edu.uta.distributed.singlethread.Server;
...
public class ServerThread implements Runnable {
	...
	private synchronized void rename(String oldfileName, String newfileName) {
	...
	private synchronized void getFileFromClient(String fileName, long fileSize) {
		try {
			File file = new File(serverFolder + "/" + fileName);
			...
			System.out.println("File" + fileName + " is uploaded to server");
